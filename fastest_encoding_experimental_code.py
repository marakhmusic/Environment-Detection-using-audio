...
def out_encoded_audio():
    ...
    f, sr = librosa.load('sarodclip.wav', sr=44100)
    print("Cute",len(a))
    #print("SRA",sr)
    ...
    b = a[0:int(sr/10)]
    e = f[int(4*sr/10):int(5*sr/10)]
    #print(sr/10)
    #print("printing", int(4*sr/10))
...
if __name__ == '__main__':
    start = time.time()
    #record_sound()
    #find_bpm('/Users/mansoorkhan/ToneTag_Experiments/Python Projects/Environment_detection/Friday_Demo/fast_mansoor45.wav')
    out_encoded_audio()
    end = time.time()
